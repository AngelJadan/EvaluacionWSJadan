...
a persistence unit "prueba2doPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba2do\pom.xml":
...
artifact ("prueba2do.war") is already built. You can build
